...
<div class="banner1-wrapper">
        ...
        <a href="paginaprodutos.php" class="buy-button1"><img src="imagens2/lotosouro.png" alt="Ícone loto" class="cart-icon"></a>
        <a href="paginaprodutos2.php" class="buy-button1"><img src="imagens2/office.png" alt="Ícone home" class="cart-icon"></a>
